...
(add-to-list 'color-themes '(color-theme-sanityinc-light "Sanityinc light" "Steve Purcell"))
(add-to-list 'color-themes '(color-theme-sanityinc-dark "Sanityinc dark" "Steve Purcell"))
