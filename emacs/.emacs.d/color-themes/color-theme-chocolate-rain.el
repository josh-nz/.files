  ...
  (color-theme-install
   (append
    (list 'color-theme-chocolate-rain
          ...
          `(org-block ((t (:foreground ,choco-brown-0))))
          `(org-checkbox ((t (:foreground ,choco-purple-0))))
          `(org-done ((t (:foreground ,choco-green-0))))
          `(org-hide ((t (:foreground ,choco-bg))))
          `(org-level-1 ((t (:foreground ,choco-yellow-1))))
          `(org-level-2 ((t (:foreground ,choco-brown-2))))
          `(org-meta-line ((t (:foreground ,choco-blue-0))))
...
(add-to-list 'color-themes '(color-theme-chocolate-rain "Chocolate rain" "Mark Tran"))

(provide 'color-theme-chocolate-rain)
